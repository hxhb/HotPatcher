...
)
{
	...
	for(auto& Platform:CookPlatforms)
	{
		...
		if(CookActionCallback.BeginCookCallback)
		{
...
)
{
	...
	{
		UFlibHotPatcherEditorHelper::CookAssets(SoftObjectPaths,Platforms,CookActionCallback,PlatformSavePackageContext,InSavePath);
	}
}
