...
namespace THotPatcherTemplateHelper
{
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("GetUEnum"),FColor::Red);
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("GetEnumNameByValue"),FColor::Red);
		FString result;
		{
			FString TypeName;
			FString ValueName;
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("GetEnumValueByName"),FColor::Red);
		bool bStatus = false;
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("TSerializeStructAsJsonObject"),FColor::Red);
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("TDeserializeJsonObjectAsStruct"),FColor::Red);
		bool bStatus = false;
		if(OutJsonObject.IsValid())
		{
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("TSerializeStructAsJsonString"),FColor::Red);
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("TDeserializeJsonStringAsStruct"),FColor::Red);
		bool bRunStatus = false;
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("HasPrroperty"),FColor::Red);
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("ReplaceProperty"),FColor::Red);
		TSharedPtr<FJsonObject> DeserializeJsonObject;
	...
	{
		SCOPED_NAMED_EVENT_TCHAR(TEXT("SplitArray"),FColor::Red);
